...
contract TestRebaseTokenTransfers is Test {
    ...
    // function testSafeTransferFromWithApproval() public {
    //     uint256 aliceBalanceBefore = rebaseToken.balanceOf(alice);
    //     uint256 charlieBalanceBefore = rebaseToken.balanceOf(charlie);
    ...
    //     vm.prank(bob);
    //     bool success = rebaseToken.safeTransferFrom(alice, charlie, 1_500e18, "");

    //     assertTrue(success, "SafeTransferFrom should return true");
    //     assertEq(rebaseToken.balanceOf(alice), aliceBalanceBefore - 1_500e18, "Alice's balance should decrease");
    //     assertEq(rebaseToken.balanceOf(charlie), charlieBalanceBefore + 1_500e18, "Charlie's balance should increase");
    //     assertEq(rebaseToken.allowance(alice, bob), 500e18, "Allowance should decrease");
    // }

    // function testSafeTransferFromWithoutApproval() public {
    //     vm.prank(bob);
    //     vm.expectRevert();
    //     rebaseToken.safeTransferFrom(alice, charlie, 1_000e18, "");
    // }

    // function testSafeTransferFromMoreThanAllowance() public {
    //     vm.prank(alice);
    //     rebaseToken.approve(bob, 1_000e18);

    //     vm.prank(bob);
    //     vm.expectRevert();
    //     rebaseToken.safeTransferFrom(alice, charlie, 1_001e18, "");
    // }
    ...
    //     vm.prank(bob);
    //     vm.expectRevert();
    //     rebaseToken.safeTransferFrom(alice, address(0), 1_000e18, "");
    // }
    ...
    //     vm.prank(bob);
    //     bool success = rebaseToken.safeTransferFrom(alice, charlie, 1_500e18, data);
    ...
    // function testSafeTransferFromAfterRebase() public {
    //     uint256 rebaseAmount = 1_000e18;
    //     rebaseToken.rebase(rebaseAmount);
