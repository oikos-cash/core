...
contract OikosToken is Initializable, ERC20Upgradeable, OwnableUpgradeable, UUPSUpgradeable {
    ...
    // State variables - MUST match deployed storage layout
    IAddressResolver public resolver; // slot 0: The address resolver contract.
    uint256 public maxTotalSupply;    // slot 1: The maximum total supply of the token.
    OikosDividends public dividendsManager; // slot 2: Added after initial deployment.
    address public manager;           // slot 3: The manager address.
    ...
    function setDividendsManager(OikosDividends _manager) external onlyOwner {
    ...
    function renounceOwnership() public override onlyOwner {
        // [C-01 FIX] Call parent implementation instead of infinite recursive call
