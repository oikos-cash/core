...
contract DeploySatellite is Script {
    ...
    function run() public {  
        ...
        console2.log("Resolver Address:", addresses.Resolver);
        ...
        console.log("  ExchangeHelper address: ", address(exchangeHelper));

        configureResolver();

        console.log("  ModelHelper address: ", address(modelHelper));
        console.log("  AdaptiveSupply address: ", address(adaptiveSupply));
        console.log("  RewardsCalculator address: ", address(rewardsCalculator));
